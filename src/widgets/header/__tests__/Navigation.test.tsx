...
describe('Navigation', () => {
  ...
  it('highlights the active navigation item', () => {
    ...
    expect(tasksLink).toHaveClass('hover:text-gray-900')
  ...
  it('highlights tasks page when active', () => {
    ...
    expect(tasksLink).toHaveClass('bg-blue-100')
  ...
  it('highlights about page when active', () => {
    ...
    expect(aboutLink).toHaveClass('text-blue-700')
  })
  ...
  it('has proper navigation structure and styling', () => {
    ...
    expect(logo).toHaveClass('text-gray-800')
  })
  ...
  it('displays navigation items with proper spacing and layout', () => {
    ...
    const links = [homeLink, tasksLink, aboutLink]
    links.forEach(link => {
