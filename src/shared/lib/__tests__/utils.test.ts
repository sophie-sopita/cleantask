// First, let's create some utility functions to test
...
describe('Utility Functions', () => {
  describe('formatDate', () => {
    ...
    it('handles different dates correctly', () => {
      ...
      expect(formatDate(date1)).toMatch(/25 de diciembre de 2024/)
      expect(formatDate(date2)).toMatch(/1 de junio de 2024/)
    })
  })
